...
if os.path.exists(txt_name) != True:
    ...
    with open(txt_name,"w") as txt:
        ...
        with pdfplumber.open("/Users/alikemaltopak/Library/CloudStorage/OneDrive-Kişisel/VSCODE_PERSONAL_PY/Math141-Final Grades.pdf") as pdf:        # Pdf name or path
    ...
    def calculate_avg():
        data = get_list("/Users/alikemaltopak/Library/CloudStorage/OneDrive-Kişisel/VSCODE_PERSONAL_PY/exam.txt")            # Here
    ...
    while True:
        ...
        if islem == 1:
            print(totalavg("/Users/alikemaltopak/Library/CloudStorage/OneDrive-Kişisel/VSCODE_PERSONAL_PY/exam.txt"))            # Here
        elif islem == 2:
            graph()
        elif islem == 3:
            see_yourgrade("/Users/alikemaltopak/Library/CloudStorage/OneDrive-Kişisel/VSCODE_PERSONAL_PY/exam.txt")           # Here
        elif islem == 4:
            print(see_arangemet("/Users/alikemaltopak/Library/CloudStorage/OneDrive-Kişisel/VSCODE_PERSONAL_PY/exam.txt"))           # Here
        elif islem == 5:
            print(see_dep_arangement("/Users/alikemaltopak/Library/CloudStorage/OneDrive-Kişisel/VSCODE_PERSONAL_PY/exam.txt"))          # Here
        else:
            break